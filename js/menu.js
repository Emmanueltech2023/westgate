...
const MENU = {
  food: {
    ...
    { type: "list", title: "Spicy Gizzard with Yam", price: "₦3,500" },
    { type: "list", title: "Spicy Turkey with Fries", price: "₦7,000" },
    { type: "list", title: "Ugba & Stock Fish", price: "₦10,000" },
    ...
    { type: "list", title: "Snail (Small 2pcs)", price: "₦7,000" }
      ...
      "Meat & Poultry": [
        ...
        { type: "list", title: "Cowtail n Yam Pepper Soup", price: "₦8,000" },
        ...
        { type: "list", title: "Isi Ewu", price: "₦15,000" },
        { type: "list", title: "Nkwobi", price: "₦7,000" }
    ]
  },
...
drinks: {       
 "Aperitif": [
  ...
  "Cognac/Brandy": [
    { type: "card", title: "Glenfiddich Scotch Whisky 21yrs 700ml", price: "₦400,000", img:"/image/glen.webp", tags:["popular"] },
    ...
    { type: "list", title: "Hennesey vs Cognac 70cl", price: "₦100,000" },
  ...
  "Beer/Cider": [
    { type: "list", title: "BUDWEISER BIG", price: "₦4,000" },
    { type: "list", title: "Guinness big", price: "₦4,000" },
  ...
  "EnergyDrinks": [
    { type: "list", title: "red bull", price: "₦3,500" },
    { type: "list", title: "BULLET", price: "₦3,000" },
  ...
  "SoftDrinks": [
    { type: "list", title: "STUTE CRANBERRY", price: "₦9,000" },
    { type: "list", title: "5 ALIVE BERRY BLAST", price: "₦4,000" },
    ...
    { type: "list", title: "VIRGIN COLADA", price: "₦3,500" },
    { type: "list", title: "VIRGIN SUNSET", price: "₦3,000" },
  ...
  "Cocktails": [
    ...
    { type: "list", title: "MAGARITA", price: "₦4,500" },
