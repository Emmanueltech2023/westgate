const MENU = {
  food: {
    "Mains": [
      { type:"card", title:"Ofada Rice", desc:"Traditional ofada, spicy sauce with assorted meat", price:"₦5,000", img:"/image/ofada.jpg", tags:["signature","popular"] },
...
function stopSpin(){
  ...
  if(spinBtn) {
    spinBtn.style.backgroundColor = "none";
    spinBtn.style.display = "none";
  }
}

// Automatically stops loading animation 1 second after script executes
